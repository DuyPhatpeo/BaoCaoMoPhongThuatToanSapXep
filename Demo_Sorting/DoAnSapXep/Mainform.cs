    ...
    public partial class    Mainform : Form
    {
        ...
        private void DieuChinhControls(bool isRunning)
        {
            if (isRunning)
            {
                ...
                thuattoanpanel.Enabled = khoitaopanel.Enabled = Loaisapxeppanel.Enabled = false;
            }
            else
            {
                foreach (Node item in DanhSachNode)
                ...
                dungbtn.Enabled = huybnt.Enabled = false;
                thuattoanpanel.Enabled = khoitaopanel.Enabled = Loaisapxeppanel.Enabled = true;
            }
        }
        ...
        #region  Hiển thị mảng đang sắp xếp
        ...
        private void Hienthimangdangsapxep(int k, int j, string thamso1, string thamso2)
        {
            ...
            daydangxepListbox.ForeColor = Color.Black;
        ...
        private void addYTuong()
        {
            ...
            this.yTuongTextBox.Text = HienThiThuatToan.yTuong;
        }
        #endregion
        ...
        #region Nút tạm dừng, tiếp tục, hủy
        ...
        private void dungbtn_Click(object sender, EventArgs e)
        {
            if (Node.IsPause)
            {
                Node.pauseStatus.Set();     // hàm để tiếp
                Node.IsPause = false;
                dungbtn.Text = "Dừng";
                timer1.Start();
            }
            ...
            {
                Node.pauseStatus.Reset();    // hàm để dừng
                Node.IsPause = true;
                dungbtn.Text = "Tiếp";
                timer1.Stop();
            }
        ...
        #region thread va tack , thread co the abort bất kỳ lúc nào, task có thể callback
        ...
        #region  Thông báo hoàn tất sắp xếp
